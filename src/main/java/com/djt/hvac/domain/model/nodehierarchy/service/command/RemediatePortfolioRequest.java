...
@JsonDeserialize(builder = RemediatePortfolioRequest.Builder.class)
public class RemediatePortfolioRequest extends AbstractNodeHierarchyCommandRequest {
  ...
  public static Builder builder (RemediatePortfolioRequest commandRequest) {
    return new Builder(commandRequest);
  }

  private RemediatePortfolioRequest (Builder builder) {
    super(builder);
  ...
  public String getOperationType() {
    return NodeHierarchyCommandRequest.REMEDIATE_OPERATION_TYPE;
  }  
  ...
  @JsonPOJOBuilder
  public static class Builder extends AbstractNodeHierarchyCommandRequest.Builder<RemediatePortfolioRequest, Builder> {
    
    private Set<IssueType> issueTypes;

    private Builder() {}

    private Builder(RemediatePortfolioRequest commandRequest) {
    ...
    @Override
    protected RemediatePortfolioRequest newInstance() {
      return new RemediatePortfolioRequest(this);
    }
  }
}