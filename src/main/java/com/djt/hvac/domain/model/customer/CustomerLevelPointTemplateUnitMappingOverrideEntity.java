 ...
 *
 */
public class CustomerLevelPointTemplateUnitMappingOverrideEntity extends AbstractPointTemplateUnitMappingOverrideEntity {
  private static final long serialVersionUID = 1L;
  private final AbstractCustomerEntity parentCustomer;
  
  public CustomerLevelPointTemplateUnitMappingOverrideEntity(
  ...
  public String getNaturalIdentity() {
    return new StringBuilder()
        ...
        .append(this.parentCustomer.getNaturalIdentity())
        .toString();
  }    
}
//@formatter:on