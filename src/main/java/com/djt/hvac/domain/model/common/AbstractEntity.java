package com.djt.hvac.domain.model.common;
...
import com.djt.hvac.domain.model.common.timekeeper.impl.TimeKeeperImpl;
import com.djt.hvac.domain.model.common.utils.CalendarAligners;
...
public abstract class AbstractEntity implements Comparable<AbstractEntity>, Serializable {
   ...
   *  
   * @param simpleValidationMessages A list of simple validation messages identified.
   */
  public void validateSimple(List<SimpleValidationMessage> simpleValidationMessages) {
  }
  
  public List<SimpleValidationMessage> validateSimple() {

    List<SimpleValidationMessage> simpleValidationMessages = new ArrayList<>();
    validateSimple(simpleValidationMessages);
    Collections.sort(simpleValidationMessages);
    return simpleValidationMessages;
  }  
  /**
   * 
   * @param issueTypes A list of issue types to validate for
   * @param validationMessages A list of issues
   * @param remediate Whether or not to automatically fix the identified issues
   */
  ...
  public List<ValidationMessage> validate() {
    ...
    validate(issueTypes, validationMessages, false);
    Collections.sort(validationMessages);
    return validationMessages;
  }
  
  public List<ValidationMessage> validate(Set<IssueType> issueTypes) {
  ...
  public List<ValidationMessage> remediate(Set<IssueType> issueTypes) {
    ...
    List<ValidationMessage> validationMessages = new ArrayList<>();
    validate(issueTypes, validationMessages, true);
    Collections.sort(validationMessages);
    return validationMessages;
  }  
