...
class AndOperator extends AbstractBinaryExpression<Boolean, Boolean> implements LogicalOperator {
  
  static AndOperator create(Expression<Boolean> expr1, Expression<Boolean> expr2) {
    return new AndOperator(expr1, expr2);
  }
   
  private AndOperator(Expression<Boolean> expr1, Expression<Boolean> expr2) {
    super(expr1, expr2);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AndOperator other = (AndOperator) obj;
    if (expr1 == null) {
      if (other.expr1 != null)
        return false;
