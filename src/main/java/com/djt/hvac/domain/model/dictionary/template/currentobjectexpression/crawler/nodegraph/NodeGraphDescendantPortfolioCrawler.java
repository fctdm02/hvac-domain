...
public class NodeGraphDescendantPortfolioCrawler extends NodeGraphPortfolioCrawler {

  public NodeGraphDescendantPortfolioCrawler(
      Model model,
  ...
  public List<Integer> getCurrentObjects(
    ...
    try {
      ...
      for (Integer startingNodeId: startingNodeIds) {
        ...
        for (EnergyExchangeEntity targetNode: startingNode.getDescendantEnergyExchangeSystemNodes(energyExchangeSystemType)) {
