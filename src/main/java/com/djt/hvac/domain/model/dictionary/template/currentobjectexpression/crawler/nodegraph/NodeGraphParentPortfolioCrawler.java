...
public class NodeGraphParentPortfolioCrawler extends NodeGraphPortfolioCrawler {

  public NodeGraphParentPortfolioCrawler(
      Model model,
  ...
  public List<Integer> getCurrentObjects(
    ...
    try {
      ...
      for (Integer startingNodeId: startingNodeIds) {
        ...
        for (EnergyExchangeEntity targetNode: startingNode.getParentEnergyExchangeSystemNodes(energyExchangeSystemType)) {
