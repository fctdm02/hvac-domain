...
class NotEqualsExpression extends AbstractBooleanExpression {

  private final AbstractExpressionWithVariables left;
  private final AbstractExpressionWithVariables right;

  NotEqualsExpression(AbstractExpressionWithVariables left, AbstractExpressionWithVariables right) {
