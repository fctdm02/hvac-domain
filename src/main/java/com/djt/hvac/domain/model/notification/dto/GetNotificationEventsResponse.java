...
public class GetNotificationEventsResponse {
  ...
  public GetNotificationEventsResponse() {
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    GetNotificationEventsResponse other = (GetNotificationEventsResponse) obj;
    if (customerId == null) {
  ...
  public String toString() {
    ...
    builder.append("GetNotificationEventsResponse [id=").append(id).append(", eventUuid=").append(eventUuid)
