...
@JsonDeserialize(builder = AdRuleFunctionTemplateInputConstant.Builder.class)
public class AdRuleFunctionTemplateInputConstant implements Comparable<AdRuleFunctionTemplateInputConstant> {
  ...
  public static Builder builder (AdRuleFunctionTemplateInputConstant ruleTemplateInputConstant) {
    return new Builder(ruleTemplateInputConstant);
  }

  private AdRuleFunctionTemplateInputConstant (Builder builder) {
    this.id = builder.id;
  ...
  public static class Builder {
    ...
    private Builder(AdRuleFunctionTemplateInputConstant ruleTemplateInputConstant) {
    ...
    public AdRuleFunctionTemplateInputConstant build() {
      requireNonNull(id, "id cannot be null");
      requireNonNull(dataTypeId, "dataTypeId cannot be null");
      requireNonNull(unitId, "unitId cannot be null");
      requireNonNull(sequenceNumber, "sequenceNumber cannot be null");
      ...
      requireNonNull(name, "name cannot be null");
      requireNonNull(isRequired, "isRequired cannot be null");
      return new AdRuleFunctionTemplateInputConstant(this);
    }
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AdRuleFunctionTemplateInputConstant other = (AdRuleFunctionTemplateInputConstant) obj;
    if (dataTypeId == null) {
  ...
  public int compareTo(AdRuleFunctionTemplateInputConstant that) {

    return this.sequenceNumber.compareTo(((AdRuleFunctionTemplateInputConstant) that).sequenceNumber);
  }   
}