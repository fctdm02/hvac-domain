...
public class NodeHierarchyChildPortfolioCrawler extends StandardPortfolioCrawler {

  NodeHierarchyChildPortfolioCrawler(
  ...
  public List<Integer> getCurrentObjects(
    ...
    try {
      ...
      for (Integer startingNodeId: startingNodeIds) {
        ...
        for (AbstractNodeEntity targetNode: startingNode.getAllChildNodes()) {
