 ...
 *
 */
public class AdFunctionTemplateSearchCriteria extends SearchCriteria {
  ...
  public AdFunctionTemplateSearchCriteria() {
    super();
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (adFunctionTemplateId == null) {
      if (other.getAdFunctionTemplateId() != null)
        return false;
    } else if (!adFunctionTemplateId.equals(other.getAdFunctionTemplateId()))
      return false;
    if (adFunctionType == null) {
      if (other.getAdFunctionType() != null)
        return false;
    } else if (!adFunctionType.equals(other.getAdFunctionType()))
      return false;
    if (customerId == null) {
    ...
    if (energyExchangeId == null) {
      if (other.getEnergyExchangeId() != null)
        return false;
    } else if (!energyExchangeId.equals(other.getEnergyExchangeId()))
      return false;
    if (energyExchangeTypeId == null) {
      if (other.getEnergyExchangeTypeId() != null)
        return false;
    } else if (!energyExchangeTypeId.equals(other.getEnergyExchangeTypeId()))
      return false;
    if (entityState == null) {
      if (other.getEntityState() != null)
        return false;
    } else if (!entityState.equals(other.getEntityState()))
      return false;
    if (instanceId == null) {
      if (other.getInstanceId() != null)
        return false;
    } else if (!instanceId.equals(other.getInstanceId()))
      return false;
    if (nodePath == null) {
      if (other.getNodePath() != null)
        return false;
    } else if (!nodePath.equals(other.getNodePath()))
      return false;
    return true;
  }
