...
class DivisionOperator extends AbstractBinaryExpression<Double, Double> implements ArithmeticOperator {
  
  static DivisionOperator create(Expression<Double> expr1, Expression<Double> expr2) {
    return new DivisionOperator(expr1, expr2);
  }
 
  private DivisionOperator(Expression<Double> expr1, Expression<Double> expr2) {
    super(expr1, expr2);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    DivisionOperator other = (DivisionOperator) obj;
    if (expr1 == null) {
      if (other.expr1 != null)
        return false;
