...
import static com.djt.hvac.domain.model.common.dsl.baseline.Token.Type.FALSE;
...
import static com.djt.hvac.domain.model.common.dsl.baseline.Token.Type.TRUE;
...
class LexicalAnalyzerImpl implements LexicalAnalyzer {
  ...
  public Token nextToken() throws IOException {
    ...
    switch (peek) {
      ...
      case ',':
        return getToken(Type.COMMA, startPosition);
      case '=':
        if (readChar('=')) {
