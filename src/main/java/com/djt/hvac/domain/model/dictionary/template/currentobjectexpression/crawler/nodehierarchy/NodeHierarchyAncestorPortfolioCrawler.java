...
public class NodeHierarchyAncestorPortfolioCrawler extends StandardPortfolioCrawler {

  NodeHierarchyAncestorPortfolioCrawler(
  ...
  public List<Integer> getCurrentObjects(
    ...
    try {
      ...
      for (Integer startingNodeId: startingNodeIds) {
        ...
        for (AbstractNodeEntity targetNode: startingNode.getAncestorNodes()) {
