...
public class NodeHierarchyDescendantPortfolioCrawler extends StandardPortfolioCrawler {

  NodeHierarchyDescendantPortfolioCrawler(
  ...
  public List<Integer> getCurrentObjects(
    ...
    try {
      ...
      for (Integer startingNodeId: startingNodeIds) {
        ...
        for (AbstractNodeEntity targetNode: startingNode.getDescendantNodes()) {
