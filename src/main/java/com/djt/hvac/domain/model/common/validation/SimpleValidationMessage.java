...
public final class SimpleValidationMessage implements Comparable<SimpleValidationMessage> {
  
  private static final List<SimpleValidationMessage> EMPTY_LIST = new ArrayList<>();
  ...
  public SimpleValidationMessage(
  ...
  @Override
  public int compareTo(SimpleValidationMessage that) {
  ...
  public static List<SimpleValidationMessage> getInfoLevelMessages(List<SimpleValidationMessage> simpleValidationMessages) {
    
    return getFilteredMessages(simpleValidationMessages, MessageType.INFO);
  }
  
  public static List<SimpleValidationMessage> getErrorLevelMessages(List<SimpleValidationMessage> simpleValidationMessages) {

    return getFilteredMessages(simpleValidationMessages, MessageType.ERROR);
  }
  
  public static List<SimpleValidationMessage> getFilteredMessages(
      List<SimpleValidationMessage> simpleValidationMessages,
      MessageType messageType) {
    ...
    for (SimpleValidationMessage simpleValidationMessage: simpleValidationMessages) {
