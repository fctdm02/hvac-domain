...
@JsonDeserialize(builder = AdRuleFunctionTemplateInputPoint.Builder.class)
public class AdRuleFunctionTemplateInputPoint implements Comparable<AdRuleFunctionTemplateInputPoint> {
  ...
  public static Builder builder (AdRuleFunctionTemplateInputPoint ruleTemplateInputPoint) {
    return new Builder(ruleTemplateInputPoint);
  }

  private AdRuleFunctionTemplateInputPoint (Builder builder) {
    this.id = builder.id;
  ...
  public static class Builder {
    ...
    private Builder(AdRuleFunctionTemplateInputPoint ruleTemplateInputPoint) {
    ...
    public AdRuleFunctionTemplateInputPoint build() {
      requireNonNull(id, "id cannot be null");
      requireNonNull(name, "name cannot be null");
      requireNonNull(description, "description cannot be null");
      requireNonNull(isRequired, "isRequired cannot be null");
      ...
      requireNonNull(sequenceNumber, "sequenceNumber cannot be null");
      requireNonNull(tags, "tags cannot be null");
      return new AdRuleFunctionTemplateInputPoint(this);
    }
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AdRuleFunctionTemplateInputPoint other = (AdRuleFunctionTemplateInputPoint) obj;
  ...
  public int compareTo(AdRuleFunctionTemplateInputPoint that) {

    return this.sequenceNumber.compareTo(((AdRuleFunctionTemplateInputPoint) that).sequenceNumber);
  }    
}