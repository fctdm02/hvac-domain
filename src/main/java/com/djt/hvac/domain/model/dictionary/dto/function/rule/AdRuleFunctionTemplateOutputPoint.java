...
@JsonDeserialize(builder = AdRuleFunctionTemplateOutputPoint.Builder.class)
public class AdRuleFunctionTemplateOutputPoint implements Comparable<AdRuleFunctionTemplateOutputPoint> {
  ...
  public static Builder builder (AdRuleFunctionTemplateOutputPoint ruleTemplateOutputPoint) {
    return new Builder(ruleTemplateOutputPoint);
  }

  private AdRuleFunctionTemplateOutputPoint (Builder builder) {
    this.id = builder.id;
  ...
  public static class Builder {
    ...
    private Builder(AdRuleFunctionTemplateOutputPoint ruleTemplateOutputPoint) {
    ...
    public AdRuleFunctionTemplateOutputPoint build() {
      requireNonNull(id, "id cannot be null");
      requireNonNull(description, "description cannot be null");
      requireNonNull(dataTypeId, "dataTypeId cannot be null");
      requireNonNull(unitId, "unitId cannot be null");
      requireNonNull(range, "range cannot be null");
      requireNonNull(sequenceNumber, "sequenceNumber cannot be null");
      return new AdRuleFunctionTemplateOutputPoint(this);
    }
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    AdRuleFunctionTemplateOutputPoint other = (AdRuleFunctionTemplateOutputPoint) obj;
    if (dataTypeId == null) {
  ...
  public int compareTo(AdRuleFunctionTemplateOutputPoint that) {

    return this.sequenceNumber.compareTo(((AdRuleFunctionTemplateOutputPoint) that).sequenceNumber);
  }    
}